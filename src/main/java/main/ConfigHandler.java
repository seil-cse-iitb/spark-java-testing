...
//    final static String MYSQL_HOST = "10.129.149.11";
    ...
    final static String MQTT_HOST = "mqtt.seil.cse.iit.ac.in";
    final static String MQTT_URL =  "tcp://"+MQTT_HOST+":1883";
    public static final long LIVE_AGGREGATION_INTERVAL_IN_SECONDS =9;//TODO test when LIVE_AGGREGATION_INTERVAL_IN_SECONDS < LIVE_GRANULARITY_IN_SECONDS
